...
If it's not the [latest version](https://github.com/khulnasoft/ai-shell/tags), run:
...
If you want to help fix a bug or implement a feature in [Issues](https://github.com/khulnasoft/ai-shell/issues) (tip: look out for the `help wanted` label), checkout the [Contribution Guide](CONTRIBUTING.md) to learn how to setup the project.
